...
{
    var BSJSParser = objectThatDelegatesTo(OMeta, {
            'space': function () {
            ...
            'expr': function () {
                var $elf = this, _fromIdx = this.input.idx, e, t, f, rhs;
                return function () {
            ...
            'primExpr': function () {
                var $elf = this, _fromIdx = this.input.idx, p, i, m, as, f;
                return this._or(function () {
                    return function () {
                        p = this._apply('primExpr');
                        return this._or(function () {
            ...
            'primExprHd': function () {
                var $elf = this, _fromIdx = this.input.idx, e, n, s, as, es;
                return this._or(function () {
                    return function () {
                        this._applyWithArgs('token', '(');
                        e = this._apply('expr');
            ...
            'stmt': function () {
                var $elf = this, _fromIdx = this.input.idx, bs, c, t, f, s, i, u, n, v, e, cs, x;
                return this._or(function () {
    ...
    var BSSemActionParser = objectThatDelegatesTo(BSJSParser, {
    ...
    var BSJSTranslator = objectThatDelegatesTo(OMeta, {
            'trans': function () {
            ...
            'string': function () {
                ...
                return function () {
                    ...
                    return OMeta.toProgramString(s);
                }.call(this);
            },
            'regExpr': function () {
                var $elf = this, _fromIdx = this.input.idx, x;
            ...
            'binding': function () {
                ...
                return function () {
                    name = this._apply('anything');
                    val = this._apply('trans');
                    return OMeta.toProgramString(name) + ': ' + val;
                }.call(this);
            },
            'switch': function () {
...
{
    var BSOMetaParser = objectThatDelegatesTo(OMeta, {
            'space': function () {
                var $elf = this, _fromIdx = this.input.idx;
                return this._or(function () {
                    return OMeta._superApplyWithArgs(this, 'space');
            ...
            'application': function () {
                var $elf = this, _fromIdx = this.input.idx, rule, as, grm;
                return this._or(function () {
                    return function () {
                        this._applyWithArgs('token', '^');
            ...
            'expr4': function () {
                var $elf = this, _fromIdx = this.input.idx, ne, xs, act;
                return function () {
                    ne = this._apply('anything');
                    return this._or(function () {
                        return function () {
    ...
    var BSOMetaTranslator = objectThatDelegatesTo(OMeta, {
            'App': function () {
            ...
            'XOr': function () {
                ...
                return function () {
                    ...
                    xs.unshift(OMeta.toProgramString(this['name'] + '.' + this['rName']));
                    return [
                        'this._xor(',
                        xs.join(','),
                        ')'
            ...
            'intPart': function () {
                ...
                return function () {
                    ...
                    return OMeta.toProgramString(mode) + ',' + part;
                }.call(this);
            },
            'jtCase': function () {
...
{
    var BSNullOptimization = objectThatDelegatesTo(OMeta, {
            'setHelped': function () {
                var $elf = this, _fromIdx = this.input.idx;
    ...
    var BSAssociativeOptimization = objectThatDelegatesTo(BSNullOptimization, {
            'And': function () {
                var $elf = this, _fromIdx = this.input.idx, x, xs;
                return this._or(function () {
                    return function () {
    ...
    var BSSeqInliner = objectThatDelegatesTo(BSNullOptimization, {
            'App': function () {
    ...
    JumpTable['prototype']['toTree'] = function () {
        ...
        for (var i = 0; i < choiceKeys['length']; i += 1) {
            r.push([
                choiceKeys[i],
                this['choices'][choiceKeys[i]]
            ]);
        }
        ;
        return r;
    };
    var BSJumpTableOptimization = objectThatDelegatesTo(BSNullOptimization, {
            'Or': function () {
    ...
    var BSOMetaOptimizer = objectThatDelegatesTo(OMeta, {
...
{
    var BSOMetaJSParser = objectThatDelegatesTo(BSJSParser, {
            'srcElem': function () {
                var $elf = this, _fromIdx = this.input.idx, r;
                return this._or(function () {
                    return function () {
    ...
    var BSOMetaJSTranslator = objectThatDelegatesTo(BSJSTranslator, {
            'Grammar': function () {
                var $elf = this, _fromIdx = this.input.idx;
